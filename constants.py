...
CLIMATE_VARIABLES = ['Rainfall January', 'Rainfall February','Rainfall March', 'Rainfall April',
                   ...
                   'Tmax January', 'Tmax February', 'Tmax March', 'Tmax April', 'Tmax May', 'Tmax June',
                   'Tmax July', 'Tmax August', 'Tmax September', 'Tmax October', 'Tmax November', 'Tmax December',
                   'Tmin January', 'Tmin February', 'Tmin March', 'Tmin April', 'Tmin May', 'Tmin June',
